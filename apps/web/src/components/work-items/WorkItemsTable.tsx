...
interface Props {
  project: Project;
  events: WsEnvelope[];
  /** When provided, row clicks open the InitiativeInspector instead of WorkItemDetailModal. */
...
export function WorkItemsTable({ project, events, onOpenInspector, rightSlot }: Props) {
