  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "yaml": {
          "type": "string",
          "description": "raw YAML v2 workflow. NOTE: double-quote any `task:`/`prompt:` scalar that contains a colon-space (e.g. `task: \"Write X: do Y\"`) or YAML mis-parses it. Prefer `def` (object) to avoid quoting traps. See `def` for the node shape."
        },
        "def": {
          "type": "object",
